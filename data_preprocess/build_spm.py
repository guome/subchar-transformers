...
if __name__ == "__main__":
    ...
    input_dir_local = "./zhwiki-latest-pages-articles_subchar_lower.txt"
    tf.gfile.Copy(input_dir_gs, input_dir_local, overwrite=True)

    for vocab_size in [10000, 15000]:
        spm.SentencePieceTrainer.train(
            '--input=zhwiki-latest-pages-articles_subchar_lower.txt --model_prefix=./resources/tokenizer/subchar-%d-clean --vocab_size=%d --pad_id=0 --unk_id=1 --eos_id=-1 --bos_id=-1 --control_symbols=[CLS],[SEP],[MASK] --user_defined_symbols=(,),”,-,.,–,£,€ --shuffle_input_sentence=true --input_sentence_size=30000000 --character_coverage=0.99995 --model_type=bpe' % (
