...
from src import classifier_utils
...
flags.DEFINE_integer(
    ...
    "The maximum sememe sequence length. sememe sequences longer than "
    "this will be truncated, and sequences shorter than this will be padded.")
...
def main(_):
    ...
    processors = {
        ...
        # "tnews": classifier_utils.TnewsProcessor,
        # "afqmc": classifier_utils.AFQMCProcessor,
        # "iflytek": classifier_utils.iFLYTEKDataProcessor,
        # "copa": classifier_utils.COPAProcessor,
        # "cmnli": classifier_utils.CMNLIProcessor,
        # "wsc": classifier_utils.WSCProcessor,
        # "csl": classifier_utils.CslProcessor,
    ...
    if FLAGS.do_train:
        ...
        if not tf.gfile.Exists(train_file):
            classifier_utils.file_based_convert_examples_to_features(
                ...
                train_file,
                task_name,
                max_sememe_length=FLAGS.max_sememe_length,
