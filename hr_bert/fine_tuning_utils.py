...
def _create_model_from_hub(hub_module,
                           is_training,
                           input_ids,
                           input_sememe_ids,
                           input_mask,
...
def _create_model_from_scratch(albert_config,
                               is_training,
                               input_ids,
                               input_sememe_ids,
                               input_mask,
...
def create_albert(albert_config,
                  is_training,
                  input_ids,
                  input_sememe_ids,
                  input_mask,
    ...
    if hub_module:
        ...
        return _create_model_from_scratch(
            albert_config,
            is_training,
            input_ids,
            input_sememe_ids,
...
def create_vocab(bert_tokenizer_name):
    """Creates a vocab, either from vocab file or from a TF-Hub module."""
    bpe_tokenizer = BertTokenizer.from_pretrained(bert_tokenizer_name)
