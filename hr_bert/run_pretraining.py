...
flags.DEFINE_integer("max_sememe_length", 8, "Maximum sequence length.")
...
def input_fn_builder(input_files,
    ...
    def input_fn(params):
        ...
        name_to_features = {
            ...
            "input_sememe_ids": tf.FixedLenFeature([max_seq_length * max_sememe_length], tf.int64),
            "input_mask": tf.FixedLenFeature([max_seq_length], tf.int64),
            "input_sememe_mask": tf.FixedLenFeature([max_seq_length * max_sememe_length], tf.int64),
