...
export TPU_NAME=grpc://10.86.36.74:8470
...
for run_idx in `seq 1 $((RUN_TIMES))`; do
    ...
    python3 src/run_classifier.py \
      ...
      --output_dir=${STORAGE_BUCKET}/experiments/h_bert/finetune/chn_length_512_sememe_16_steps_125k_time_0512_0/ \
