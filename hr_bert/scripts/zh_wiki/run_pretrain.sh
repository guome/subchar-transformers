...
# python src/run_pretraining.py --input_file=experiments/zh_sample/wiki.valid.raw.*.tfrecord --output_dir=experiments/zh_sample/ --albert_config_file=./resources/albert_base_v2/config.json --do_train --do_eval --dev_input_file=experiments/zh_sample/wiki.valid.raw.9.tfrecord --train_batch_size=2 --eval_batch_size=2 --max_seq_length=512 --max_sememe_length=16 --max_predictions_per_seq=51 --optimizer="lamb" --learning_rate=4e-4 --num_train_steps=12 --num_warmup_steps=3 --save_checkpoints_steps=5