...
""" clue_toolkit processors and helpers """
...
class TnewsProcessor(DataProcessor):
    """Processor for the TNEWS data set (clue_toolkit version)."""
...
class IflytekProcessor(DataProcessor):
    """Processor for the IFLYTEK data set (clue_toolkit version)."""
...
class AfqmcProcessor(DataProcessor):
    """Processor for the AFQMC data set (clue_toolkit version)."""
...
class CmnliProcessor(DataProcessor):
    """Processor for the CMNLI data set (clue_toolkit version)."""
...
class CslProcessor(DataProcessor):
    """Processor for the CSL data set (clue_toolkit version)."""
...
class WscProcessor(DataProcessor):
    """Processor for the WSC data set (clue_toolkit version)."""
...
class CopaProcessor(DataProcessor):
    """Processor for the COPA data set (clue_toolkit version)."""
