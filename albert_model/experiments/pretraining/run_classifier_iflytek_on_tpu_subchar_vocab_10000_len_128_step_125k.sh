...
TASK_NAME="iflytek"
MODEL_NAME="subchar_trans_albert_base_vocab_10000_len_128_steps_125k"
...
export ALBERT_PRETRAINED_MODELS_DIR_LEN_128=${STORAGE_BUCKET}/experiments/uncased_vocab_10000_length_256_steps_125k_time_0317

export GLUE_DATA_DIR=./datasets/CLUE/

export OUTPUT_DIR_128=$STORAGE_BUCKET/experiments/${MODEL_NAME}_${TASK_NAME}_${CURRENT_TIME}
