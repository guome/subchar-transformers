...
from albert_model import clue_classifier_utils_subchar_spaced
...
def main(_):
  ...
  processors = {
      ...
      "xnli": clue_classifier_utils_subchar_spaced.XnliProcessor,
      "tnews": clue_classifier_utils_subchar_spaced.TnewsProcessor,
      "afqmc": clue_classifier_utils_subchar_spaced.AFQMCProcessor,
      "iflytek": clue_classifier_utils_subchar_spaced.iFLYTEKDataProcessor,
      "copa": clue_classifier_utils_subchar_spaced.COPAProcessor,
      "cmnli": clue_classifier_utils_subchar_spaced.CMNLIProcessor,
      "wsc": clue_classifier_utils_subchar_spaced.WSCProcessor,
      "csl": clue_classifier_utils_subchar_spaced.CslProcessor,
      "chn": clue_classifier_utils_subchar_spaced.ChnSentiCorpDataProcessor,
      "lcqmc": clue_classifier_utils_subchar_spaced.LCQMCProcessor
