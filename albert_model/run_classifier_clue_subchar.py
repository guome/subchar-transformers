...
from albert_model import clue_classifier_utils_subchar
...
def main(_):
  ...
  processors = {
      ...
      "xnli": clue_classifier_utils_subchar.XnliProcessor,
      "tnews": clue_classifier_utils_subchar.TnewsProcessor,
      "afqmc": clue_classifier_utils_subchar.AFQMCProcessor,
      "iflytek": clue_classifier_utils_subchar.iFLYTEKDataProcessor,
      "copa": clue_classifier_utils_subchar.COPAProcessor,
      "cmnli": clue_classifier_utils_subchar.CMNLIProcessor,
      "wsc": clue_classifier_utils_subchar.WSCProcessor,
      "csl": clue_classifier_utils_subchar.CslProcessor,
