...
from albert_model import clue_classifier_utils_char_spaced
...
def main(_):
  ...
  processors = {
      ...
      "xnli": clue_classifier_utils_char_spaced.XnliProcessor,
      "tnews": clue_classifier_utils_char_spaced.TnewsProcessor,
      "afqmc": clue_classifier_utils_char_spaced.AFQMCProcessor,
      "iflytek": clue_classifier_utils_char_spaced.iFLYTEKDataProcessor,
      "copa": clue_classifier_utils_char_spaced.COPAProcessor,
      ...
      "lcqmc": clue_classifier_utils_char_spaced.LCQMCProcessor
